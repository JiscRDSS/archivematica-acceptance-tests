# this acceptance test was written for Sprint 1. It is no longer needed given how we have structured 
# the features and regression tests to be built.  However, retaining here as it is a good example of using background, scenario
# outline etc.
